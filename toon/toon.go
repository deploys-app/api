...
//
// This package renders API results token-efficiently for LLM consumers. Only
// encoding is implemented; there is no decoder.
//
// Values are first interpreted using encoding/json semantics — struct tags and
// custom json.Marshaler implementations are honored — then rendered as TOON.
package toon
